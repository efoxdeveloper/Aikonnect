...
conversationRouter.get("/:conversationId/messages", requireWorkspacePermission(PERMISSIONS.CONTACTS_READ), validateParams(conversationParamsSchema), validateQuery(conversationListQuerySchema), asyncHandler(controller.messages));
